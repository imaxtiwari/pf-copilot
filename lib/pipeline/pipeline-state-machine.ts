...
const LEGAL_TRANSITIONS: Record<PipelineStage, PipelineStage[]> = {
  ...
  COMMITTEE_VOTE: ['APPROVED', 'ATLAS_COMPARISON', 'REVISION', 'DEADLOCKED', 'FAILED'],
  REVISION: ['PRIYA_BUILD', 'PROFILING_AND_GOAL_ASSESSMENT', 'COMMITTEE_VOTE', 'FAILED'],
  ATLAS_COMPARISON: ['APPROVED', 'FAILED'],
  APPROVED: [],
  DEADLOCKED: [],
  FAILED: [],
}
