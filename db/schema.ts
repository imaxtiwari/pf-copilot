...
// NOTE: Option A — chat-first tool-calling
// Pipeline, scheduler, agent-memory, and drift/SIP tables have been removed.
// If the Dhruv pipeline is revived, recreate them on the feature branch.
